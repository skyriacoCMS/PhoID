...
void Fitter(double e_min,double e_max,int bin,double &isoP,double &isoC,double &isoN){
  ...
  string fou = "Bin_"+biin.str()+"ProfPlots.root";
  string Pngg = "Bin_"+biin.str()+".png";
  ...
  f1->cd();  
  TProfile *IsoPvsPVp = IsoPvsPV->ProfileX();                                                         
  TProfile *IsoCvsPVp = IsoCvsPV->ProfileX();
  TProfile *IsoNvsPVp = IsoNvsPV->ProfileX();
  ...
  TProfile *IsoPvsPVfp = IsoPvsPVf->ProfileX();
  TProfile *IsoCvsPVfp = IsoCvsPVf->ProfileX();
  TProfile *IsoNvsPVfp = IsoNvsPVf->ProfileX();
                                                                                                      
  TProfile *IsoPvsPtp = IsoPvsPt->ProfileX();
  TProfile *IsoCvsPtp = IsoCvsPt->ProfileX();
  TProfile *IsoNvsPtp = IsoNvsPt->ProfileX();
