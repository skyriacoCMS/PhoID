...
void IsovsPt(){
  ...
  TF1 *fn1 = new TF1("fn1","[0]*x+[1]",20,200);
  TF2 *fn2 = new TF1("fn2","[0]*x+[1]",20,200);
  TF3 *fn3 = new TF1("fn3","[0]*x+[1]",20,200);

  TF1 *fp1 = new TF1("fp1","[0]*x+[1]",20,200);
  TF2 *fp2 = new TF1("fp2","[0]*x+[1]",20,200);
  TF3 *fp3 = new TF1("fp3","[0]*x+[1]",20,200);

  TF1 *fc1 = new TF1("fc1","[0]*x+[1]",20,200);
  TF2 *fc2 = new TF1("fc2","[0]*x+[1]",20,200);
  TF3 *fc3 = new TF1("fc3","[0]*x+[1]",20,200);
